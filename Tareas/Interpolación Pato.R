...
plot(x1,y1, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Diagrama ")
plot(x1,y1, pch=19, cex=1, col = "red", asp=1,xlab="X", ylab="Y", main="Diagrama ")
...
#https://www.youtube.com/watch?v=Lj7OHuz9QSs
#https://www.hidraulicafacil.com/2016/04/GraficaPatoPiceWise.html
